      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-20 px-6 py-10 lg:px-10">
          <header className="flex items-center justify-between">
            ...
            <Link
              href="#contact"
              className="rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-white/90 backdrop-blur-md transition hover:border-cyan-300/40 hover:bg-cyan-300/10"
            >
              Contact
            </Link>
          </header>
